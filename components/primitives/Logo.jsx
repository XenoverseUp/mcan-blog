...
const Shadow = ({ children }) => (
  <div className="relative after:absolute after:left-1/2 after:top-1/2 after:-z-10 after:aspect-square after:w-4 after:-translate-x-1/2 after:-translate-y-1/2 after:bg-cool-lime-300/80 after:blur-md">
    {children}
  </div>
)
