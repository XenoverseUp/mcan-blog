    ...
    <button className="inline-flex items-center gap-1 cursor-pointer group focus-visible:ring-4 rounded-sm">
      <span>
        <svg
          ...
          className={cx("w-5 h-5", {
            "stroke-blue-300": type === Publication.SNIPPETS,
            "stroke-pink-300": type === Publication.OPINIONS,
            "stroke-green-300": type === Publication.TUTORIALS,
          })}
        >
          <path
            strokeLinecap="round"
      ...
      <span
        className={cx(
          ...
          {
            "text-blue-300": type === Publication.SNIPPETS,
            "text-pink-300": type === Publication.OPINIONS,
            "text-green-300": type === Publication.TUTORIALS,
          },
        )}
      >
        {type.toLowerCase()}.
